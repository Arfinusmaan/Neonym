    ...
    projects: [
      {
        ...
        description:
          "Interactive e-learning platform with video lessons, quizzes, and progress tracking for students.",
      ...
      },
      {
        ...
        description:
          "Professional website for a local tuition center with course listings and enrollment system.",
