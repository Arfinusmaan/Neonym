      ...
      <style>
        {`
          .bento-section {
            ...
            --glow-intensity: 0;
            --glow-radius: 200px;
            --glow-color: 161, 128, 128;
            --border-color: #a18080;
            --background-dark: #fffbf5;
            --title-color: #a18080;
            --subtitle-color: #5c5451;
            --bg-color: #fffbf5;
            --purple-primary: rgba(161, 128, 128, 1);
            --purple-glow: rgba(161, 128, 128, 0.2);
            --purple-border: rgba(161, 128, 128, 0.8);
          }
            ...
            if (enableStars) {
              return (
                ...
                <div className="card__header flex justify-between gap-3 relative">
                  <span className="card__label font-bold text-base" style={{ color: "var(--title-color)" }}>{card.label}</span>
                </div>
